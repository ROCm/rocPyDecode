...
[videoDecode/requirements.txt](videoDecode/requirements.txt):
...
correct the utility path and reconfigure to restore video support. Demuxing and CPU
decoding require the optional PyAV runtime package.
