...
```bash
    /root/miniconda3/conda-bld/linux-64/rocpydecode-0.6.0-py310_0.tar.bz2
 ```
...
```bash
    ...
    conda install --use-local /root/miniconda3/conda-bld/linux-64/rocpydecode-0.6.0-py310_0.tar.bz2
```
